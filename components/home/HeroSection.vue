            ...
            <div class="px-4 sm:px-6 lg:border-r lg:border-dashed lg:border-gray-700 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
              <div>
                ...
                <h1 class="mt-4 text-3xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-3xl xl:text-3xl">
                  ...
                  <div>
                    <vue-typer  bg-gray-300  :text="$t('hero.words')"></vue-typer>
                  </div>
                </h1>
                <p class="mt-3 text-base text-gray-300 sm:mt-5">
                  {{ $t('hero.description') }}
                </p>
                <p v-if="$config.workedAt.enabled" class="mt-8 text-sm text-white tracking-wide font-semibold sm:mt-10">
                  Computer and Systems Sciences department, Stockholm University.</p>
                <p v-if="$config.workedAt.enabled" class="mt-8 text-sm text-white tracking-wide font-semibold sm:mt-2">
                  Physiology and Phamracology deparment,  Karolinska Instiutet</p>
                <br/>
                <div v-if="$config.workedAt.enabled" class="mt-5w-full sm:mx-auto lg:ml-0">
                  <div class="flex flex-wrap space-x-1 items-start items-center space-x-4 md:space-x-10">

                    <a  href="https://su.se" target="_blank" rel="noreferrer" class="flex items-center justify-center">
                      <img  src="/images/su.png" width="124" class=" rounded-sm sm:h-34" alt="Stockhom University"/>
                    </a>
                    <a  href="https://ki.se" target="_blank" rel="noreferrer" class="flex items-center justify-center">
                      <img  src="/images/ki.png" class="h-28  sm:h-30"  alt="Karolinksa Institutet"/>
                    </a>
...
>>> .vue-typer .custom.char {
  @apply text-turquoise-500 bg-gray-800;
}
